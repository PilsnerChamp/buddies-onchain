...
const HATCH_DESCRIPTION =
    'Your buddy — a non-transferable identity, derived\n' +
    'from your account and hatched onto Base.\n' +
    'One account, one buddy. The contract holds it;\n' +
    'it can never be sold or transferred to anyone else.\n' +
    'Stage 1 of two; stage 2 is dormant.';
