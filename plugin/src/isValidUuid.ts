// plugin/src/isValidUuid.ts
//
// GENERATED FILE — DO NOT EDIT DIRECTLY.
// Vendored copy of `shared/isValidUuid.ts`, produced by `bun run sync-shared`
...
// Edit `shared/isValidUuid.ts` and re-run `bun run sync-shared` — never hand-edit
