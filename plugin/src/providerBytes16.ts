// plugin/src/providerBytes16.ts
//
// GENERATED FILE — DO NOT EDIT DIRECTLY.
// Vendored copy of `shared/providerBytes16.ts`, produced by `bun run sync-shared`
...
// Edit `shared/providerBytes16.ts` and re-run `bun run sync-shared` — never hand-edit
